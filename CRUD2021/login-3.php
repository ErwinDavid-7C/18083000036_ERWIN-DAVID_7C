<?php
session_start();
// Jika bisa login maka ke index-3.php
if (isset($_SESSION['login'])) {
    header('location:index-3.php');
    exit;
}

// Memanggil atau membutuhkan file function-3.php
require 'function-3.php';
...
if (isset($_POST['login'])) {
    ...
    // jika $cek lebih dari 0, maka berhasil login dan masuk ke index-3.php
    if ($cek > 0) {
        $_SESSION['login'] = true;
